...
import{$getmsg,$postmsg,$getuser}from'@/api/chat'
...
<template>
    ...
    <drawer v-model:open="open">
        ...
        <a-tabs v-model:activeKey="select":key="select"@change="select?(island.cnt=0):(world.cnt=0)">
            <a-tab-pane v-for="(v1,i1) in ['世界',data.island.name]":key="i1":tab="v1">
                <div class="panel">
