...
export const $getuser=async(user_id:string)=>(await $get('/user/detail',{user_id})).data
export const $getisland=async(island_id:string)=>(await $get('/island/detail',{island_id})).data
export const $getmsg=async(island_id:string,timestamp=Date.now())=>(await $get('/chat/get',{island_id,timestamp})).data
export const $postmsg=async(user_id:string,island_id:string,message:string,timestamp=Date.now())=>
    (await $post('/chat/send',{user_id,island_id,message,timestamp})).data